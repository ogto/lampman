...
export async function GET() {
  ...
  const body = `<?xml version="1.0" encoding="UTF-8"?><rss version="2.0"><channel><title>램프맨 블로그</title><link>${origin}/blog</link><description>대전·청주 전기수리와 전기공사 현장 가이드</description><language>ko-KR</language>${items}</channel></rss>`;
